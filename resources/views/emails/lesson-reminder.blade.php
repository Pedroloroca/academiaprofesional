...
<body>
    <div class="container">
        ...
        <p>Hola,</p>
        <p>Te recordamos que tienes una nueva lección disponible o próxima a comenzar:</p>
        <p><strong>Curso:</strong> {{ $courseTitle }}</p>
        <p><strong>Lección:</strong> {{ $lessonTitle }}</p>
        <p>¡No faltes y sigue avanzando hacia tus metas!</p>
        <div class="footer">
