...
<div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-50/50">
    <div class="sm:mx-auto sm:w-full sm:max-w-md select-none">
        ...
        <p class="text-center text-sm text-gray-500 mt-2">Accede a tu cuenta de la academia profesional</p>
    </div>
        ...
        <div class="bg-white py-10 px-6 shadow-xl border border-gray-100 rounded-3xl sm:px-12 relative overflow-hidden">
            ...
            @if ($errors->any())
                <div class="mb-6 bg-red-50 border-l-4 border-red-500 p-4 rounded-xl shadow-sm">
                    <h3 class="text-sm font-extrabold text-red-800">Hay problemas con tu acceso:</h3>
            ...
            <div class="mt-8 border-t border-gray-100 pt-6">
                <p class="text-center text-sm text-gray-500 select-none">
                    ¿No tienes cuenta? <a href="{{ route('register') }}" class="font-extrabold text-indigo-600 hover:text-indigo-500">Regístrate gratis</a>
                </p>
            </div>
            ...
            <div class="mt-8 pt-6 border-t border-gray-100 select-none">
                <h3 class="text-xs font-black text-gray-400 mb-4 text-center uppercase tracking-wider">Acceso Rápido (Desarrollo)</h3>
                <div class="flex flex-col gap-3">
                    <a href="/dev/login/admin" class="w-full flex justify-center px-4 py-3 bg-gray-900 text-white text-sm font-extrabold rounded-xl hover:bg-gray-800 transition-colors shadow-sm">Entrar como Administrador</a>
                    <a href="/dev/login/teacher" class="w-full flex justify-center px-4 py-3 bg-indigo-50 text-indigo-700 text-sm font-extrabold rounded-xl hover:bg-indigo-100 transition-colors">Entrar como Profesor</a>
                    <a href="/dev/login/student" class="w-full flex justify-center px-4 py-3 bg-green-50 text-green-700 text-sm font-extrabold rounded-xl hover:bg-green-100 transition-colors">Entrar como Alumno</a>
                </div>
            </div>
            @endif
        </div>
